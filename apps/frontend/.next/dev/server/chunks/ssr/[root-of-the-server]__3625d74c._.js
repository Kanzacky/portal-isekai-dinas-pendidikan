...
const LoginPage = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/api/bridge/login', {
                username,
                password
            });
            ...
            setError(err.response?.data?.message || "Kredensial salah atau server bermasalah.");
        } finally{
            setLoading(false);
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3625d74c._.js.map