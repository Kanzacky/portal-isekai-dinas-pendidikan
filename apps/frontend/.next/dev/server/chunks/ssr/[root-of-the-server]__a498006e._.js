...
async function fetchAutoToken() {
    try {
        const clientKey = process.env.NEXT_USER_KEY;
        const clientSecret = process.env.NEXT_USER_SECRET;
        const authHeader = btoa(`${clientKey}:${clientSecret}`);
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/api/bridge/login', {}, {
            headers: {
...
async function postData(endpoint, data = {}, customHeader = {}) {
    try {
        ...
        return await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/api/bridge/login', data, {
            headers: {
                'X-ENDPOINT': endpoint,
                'X-Timestamp': new Date().toISOString(),
...
"[project]/lib/tools/data:407a01 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$tools$2f$data$3a$407a01__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/tools/data:407a01 [app-ssr] (ecmascript) <text/javascript>");
"use client";
;
;
;
...
const LoginPage = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const encryptedPassword = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$tools$2f$data$3a$407a01__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["encryptChunkRSA"])(password);
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2f$postData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])('/auth/login', {
                username: username,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a498006e._.js.map