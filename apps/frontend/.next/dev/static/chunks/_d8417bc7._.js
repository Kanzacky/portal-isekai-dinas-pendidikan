...
async function fetchAutoToken() {
    try {
        const clientKey = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_USER_KEY;
        const clientSecret = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_USER_SECRET;
...
async function postData(endpoint, data = {}, customHeader = {}) {
    try {
        ...
        if (endpoint === '/auth/login') {
            ...
            if (token) authHeaderValue = `Bearer ${token}`;
        }
        return await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/api/bridge/login', data, {
            headers: {
                'X-ENDPOINT': endpoint,
                'X-Timestamp': new Date().toISOString(),
...
const LoginPage = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const encryptedPassword = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$tools$2f$data$3a$407a01__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["encryptChunkRSA"])(password);
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2f$postData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])('/auth/login', {
                username: username,
                password: password // NOT encryptedPassword
            });
...
//# sourceMappingURL=_d8417bc7._.js.map