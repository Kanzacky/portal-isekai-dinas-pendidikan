...
const LoginPage = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/api/bridge/login', {
                username,
                password
            });
...
//# sourceMappingURL=components_LoginPage_tsx_70734f75._.js.map