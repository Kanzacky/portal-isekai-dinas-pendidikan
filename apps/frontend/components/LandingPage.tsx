        ...
        <main className="flex-1 mt-20">
          ...
          <section className="py-20 max-w-[1280px] mx-auto px-6">
            <div className="flex items-end justify-between mb-12 border-l-4 border-accent pl-6">
              <div>
                <h2 className="text-slate-900 dark:text-white text-2xl md:text-3xl font-bold tracking-tight mb-2">Akses Cepat Layanan</h2>
                <p className="text-slate-500 dark:text-slate-400 mt-2 font-medium text-sm md:text-base">Temukan layanan administrasi dan informasi dengan mudah</p>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="group bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                ...
                <h3 className="text-slate-900 dark:text-white text-lg md:text-xl font-bold mb-2">PPDB</h3>
                <p className="text-slate-500 dark:text-slate-400 text-sm md:text-base leading-relaxed mb-6">Pendaftaran Peserta Didik Baru tingkat TK, SD, dan SMP.</p>
              ...
              <div className="group bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                ...
                <h3 className="text-slate-900 dark:text-white text-lg md:text-xl font-bold mb-2">Sertifikasi Guru</h3>
                <p className="text-slate-500 dark:text-slate-400 text-sm md:text-base leading-relaxed mb-6">Layanan administrasi, tunjangan, dan pengembangan profesi guru.</p>
                <a href="#" className="inline-flex items-center text-primary font-bold text-sm gap-2">
              ...
              <div className="group bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                ...
                <h3 className="text-slate-900 dark:text-white text-lg md:text-xl font-bold mb-2">Info Beasiswa</h3>
                <p className="text-slate-500 dark:text-slate-400 text-sm md:text-base leading-relaxed mb-6">Informasi bantuan pendidikan daerah untuk siswa berprestasi.</p>
                <a href="#" className="inline-flex items-center text-primary font-bold text-sm gap-2">
              ...
              <div className="group bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                ...
                <h3 className="text-slate-900 dark:text-white text-lg md:text-xl font-bold mb-2">Dapodik</h3>
                <p className="text-slate-500 dark:text-slate-400 text-sm md:text-base leading-relaxed mb-6">Sinkronisasi Data Pokok Pendidikan untuk sekolah-sekolah.</p>
                <a href="#" className="inline-flex items-center text-primary font-bold text-sm gap-2">
          ...
          <section className="bg-slate-50 dark:bg-slate-900/50 py-24">
            <div className="max-w-[1280px] mx-auto px-6">
              <div className="text-center mb-16">
                <h2 className="text-slate-900 dark:text-white text-2xl md:text-3xl font-bold tracking-tight mb-4">Berita Terbaru</h2>
                <p className="text-slate-500 dark:text-slate-400 max-w-2xl mx-auto font-medium text-sm md:text-base">Informasi terkini mengenai kebijakan, prestasi, dan agenda pendidikan di wilayah kami.</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
