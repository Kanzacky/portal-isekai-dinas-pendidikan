...
export default function ProfilePage() {
  return (
    <div className="bg-background-light dark:bg-background-dark text-[#0d141b] dark:text-slate-50 min-h-screen overflow-x-hidden font-display">
      <header className="fixed top-0 left-0 right-0 z-50 w-full bg-white/80 dark:bg-background-dark/80 backdrop-blur-md border-b border-solid border-[#e7edf3] dark:border-slate-800">
        <div className="max-w-[1200px] mx-auto px-4 md:px-10 py-3 flex items-center justify-between">
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden lg:flex items-center gap-8">
              ...
              <Link href="/profile" className="text-sm font-bold text-primary border-b-2 border-primary">Profile</Link>
              <Link href="/services" className="text-sm font-medium hover:text-primary transition-colors">Services</Link>
              <Link href="/info" className="text-sm font-medium hover:text-primary transition-colors">News</Link>
          ...
          <div className="flex items-center gap-4">
            <div className="relative hidden sm:block">
              ...
              <input className="w-48 lg:w-64 bg-[#e7edf3] dark:bg-slate-800 border-none rounded-lg py-2 pl-10 pr-4 text-sm focus:ring-2 focus:ring-primary outline-none" placeholder="Search profile..." />
            </div>
      ...
      <main className="max-w-[1200px] mx-auto px-4 md:px-10 py-8 mt-16">
          ...
          <div className="relative min-h-[500px] rounded-xl overflow-hidden flex items-center justify-center p-8 bg-cover bg-center" style={{ backgroundImage: 'linear-gradient(rgba(13, 20, 27, 0.7), rgba(13, 20, 27, 0.7)), url("https://lh3.googleusercontent.com/aida-public/AB6AXuAyPzZK-rFY07uNaVKgpFtGvMhnyHObkr-MmLd0c7mB1NhkHWCLCHS1fCkYLCo_QlygcuTP4DT-ZHgy6TZ91HFQ1PfA8RbAB-m0dBBilc6zaAFBtoYJKZfXMWWyCaJpwO4CItdTE1DcU6vcfouS8CbtNoBEqI__0tdi8y_-IiSxJAgYaPQAxjMMeUllXvFqNKjw64ufRBCoO65dgQTQZaxG6ZQbHEgFydMc-Ahqfb8zad5JtBO1XqsFAr1_uWW6UnCV7vuzIMC4AsbC")' }}>
            <div className="max-w-3xl text-center text-white space-y-6">
              ...
              <div className="p-6 bg-white/10 backdrop-blur-md rounded-xl border border-white/20">
                <p className="text-xl md:text-2xl font-light italic mb-4">"Mewujudkan Pendidikan Berkualitas, Inklusif, dan Berkarakter untuk Masa Depan Bangsa."</p>
                <div className="grid md:grid-cols-3 gap-6 text-sm text-left border-t border-white/20 pt-6 mt-6">
                  <div className="space-y-2">
                    <span className="text-primary font-bold">01. Kualitas</span>
                    <p className="text-slate-300 leading-relaxed">Meningkatkan standar mutu pendidik dan sarana prasarana sekolah secara berkelanjutan.</p>
                  </div>
                  <div className="space-y-2">
                    <span className="text-primary font-bold">02. Aksesibilitas</span>
                    <p className="text-slate-300 leading-relaxed">Menjamin akses pendidikan yang adil dan merata bagi seluruh lapisan masyarakat tanpa terkecuali.</p>
                  </div>
                  <div className="space-y-2">
                    <span className="text-primary font-bold">03. Integritas</span>
                    <p className="text-slate-300 leading-relaxed">Membangun karakter peserta didik yang berintegritas, kreatif, dan berdaya saing global.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="mb-20">
          <div className="flex items-center gap-4 mb-10">
            ...
            <h2 className="text-3xl font-bold tracking-tight">Struktur Organisasi</h2>
          </div>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-slate-800 p-8 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col gap-5 group hover:border-primary transition-colors">
              ...
              <div>
                <h4 className="text-xl font-bold mb-3">Perumusan Kebijakan</h4>
                <ul className="space-y-2 text-sm text-[#4c739a] leading-relaxed">
            ...
            <div className="bg-white dark:bg-slate-800 p-8 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col gap-5 group hover:border-primary transition-colors">
              ...
              <div>
                <h4 className="text-xl font-bold mb-3">Manajemen Satuan</h4>
                <ul className="space-y-2 text-sm text-[#4c739a] leading-relaxed">
            ...
            <div className="bg-white dark:bg-slate-800 p-8 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col gap-5 group hover:border-primary transition-colors">
              ...
              <div>
                <h4 className="text-xl font-bold mb-3">Pengembangan SDM</h4>
                <ul className="space-y-2 text-sm text-[#4c739a] leading-relaxed">
      ...
      <footer className="bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 pt-16 pb-8">
        <div className="max-w-[1200px] mx-auto px-4 md:px-10 grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-xl font-bold tracking-tight">Dinas Pendidikan</h2>
            </div>
            <p className="text-sm text-[#4c739a] leading-relaxed">Mengabdi untuk mencerdaskan kehidupan bangsa melalui layanan pendidikan yang prima dan akuntabel.</p>
          </div>
          <div>
            <h5 className="font-bold mb-6">Tautan Cepat</h5>
            <ul className="space-y-4 text-sm text-[#4c739a]">
              ...
              <li><Link href="/info" className="hover:text-primary transition-colors">Data Statistik</Link></li>
              <li><a href="#" className="hover:text-primary transition-colors">PPDB Online</a></li>
            </ul>
          </div>
          <div>
            <h5 className="font-bold mb-6">Kontak Kami</h5>
            <ul className="space-y-4 text-sm text-[#4c739a]">
              <li className="flex gap-3"><span className="material-symbols-outlined text-primary text-lg">location_on</span> Jl. Pendidikan No. 45, Jakarta Pusat</li>
              <li className="flex gap-3"><span className="material-symbols-outlined text-primary text-lg">call</span> (021) 555-0123</li>
              <li className="flex gap-3"><span className="material-symbols-outlined text-primary text-lg">mail</span> info@disdik.go.id</li>
            </ul>
          </div>
          <div>
            <h5 className="font-bold mb-6">Media Sosial</h5>
            <div className="flex gap-4">
              <div className="size-10 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center hover:bg-primary hover:text-white transition-all cursor-pointer">
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-10 border-t border-slate-100 dark:border-slate-800 pt-8 text-center">
          <p className="text-xs text-[#4c739a] uppercase tracking-widest">© 2024 Dinas Pendidikan. Hak Cipta Dilindungi.</p>
        </div>
      </footer>
    </div>
  );
