...
export default function InfoPage() {
  return (
    <div className="bg-background-light dark:bg-background-dark text-[#0d141b] dark:text-slate-50 min-h-screen transition-colors duration-200 font-public">
      <header className="fixed top-0 left-0 right-0 z-50 w-full border-b border-[#e7edf3] dark:border-slate-800 bg-white/80 dark:bg-background-dark/80 backdrop-blur-md">
        <div className="max-w-[1280px] mx-auto px-4 md:px-10 py-3 flex items-center justify-between">
          <div className="flex items-center gap-8">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-[#0d141b] dark:text-slate-50 text-lg font-bold leading-tight tracking-tight">Dinas Pendidikan</h2>
            </div>
            <nav className="hidden lg:flex items-center gap-6">
              ...
              <Link href="/info" className="text-primary text-sm font-bold">Informasi</Link>
              <a href="#" className="text-sm font-medium hover:text-primary transition-colors">Transparansi</a>
              <Link href="/contact" className="text-sm font-medium hover:text-primary transition-colors">Kontak</Link>
            </nav>
          </div>
          <div className="flex items-center gap-4">
            <div className="hidden md:flex items-center bg-[#e7edf3] dark:bg-slate-800 rounded-lg px-3 py-1.5 border border-transparent focus-within:border-primary/50 transition-all">
              <span className="material-symbols-outlined text-[#4c739a] text-xl">search</span>
              <input className="bg-transparent border-none focus:ring-0 text-sm w-40 lg:w-64 placeholder-[#4c739a] dark:placeholder-slate-500" placeholder="Cari dokumen..." />
            </div>
            <button className="bg-primary hover:bg-primary/90 text-white text-sm font-bold py-2 px-5 rounded-lg transition-colors">
              Masuk
            </button>
          </div>
        </div>
      ...
      <main className="max-w-[1280px] mx-auto px-4 md:px-10 py-8 mt-16">
        <nav className="flex items-center gap-2 mb-6">
          <Link href="/" className="text-[#4c739a] hover:text-primary text-sm font-medium flex items-center gap-1">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
          <div className="max-w-2xl">
            <h1 className="text-[#0d141b] dark:text-white text-4xl font-black leading-tight tracking-tight mb-3">Informasi & Transparansi</h1>
            <p className="text-[#4c739a] dark:text-slate-400 text-lg">Akses publik untuk laporan kinerja, anggaran, regulasi pendidikan, dan dokumen resmi lainnya guna mendukung tata kelola yang terbuka.</p>
          </div>
          <Link href="/contact" className="flex items-center gap-2 bg-white dark:bg-slate-800 border border-[#cfdbe7] dark:border-slate-700 text-[#0d141b] dark:text-slate-200 py-2.5 px-6 rounded-lg font-bold text-sm hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-[#e7edf3] dark:border-slate-800 hover:shadow-md transition-shadow group">
                ...
                <h3 className="text-[#0d141b] dark:text-white font-bold text-lg mb-1 group-hover:text-primary transition-colors">Laporan Akuntabilitas 2023</h3>
              ...
              <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-[#e7edf3] dark:border-slate-800 hover:shadow-md transition-shadow group">
                ...
                <h3 className="text-[#0d141b] dark:text-white font-bold text-lg mb-1 group-hover:text-primary transition-colors">Kalender Pendidikan 2024/2025</h3>
              ...
              <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-[#e7edf3] dark:border-slate-800 hover:shadow-md transition-shadow group">
                ...
                <h3 className="text-[#0d141b] dark:text-white font-bold text-lg mb-1 group-hover:text-primary transition-colors">Regulasi PPDB Jalur Prestasi</h3>
              ...
              <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-[#e7edf3] dark:border-slate-800 hover:shadow-md transition-shadow group">
                ...
                <h3 className="text-[#0d141b] dark:text-white font-bold text-lg mb-1 group-hover:text-primary transition-colors">Realisasi Anggaran Triwulan IV</h3>
      ...
      <footer className="mt-20 border-t border-[#e7edf3] dark:border-slate-800 bg-white dark:bg-background-dark py-12">
        <div className="max-w-[1280px] mx-auto px-4 md:px-10 grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              <span className="material-symbols-outlined text-primary text-3xl">account_balance</span>
              <h2 className="text-[#0d141b] dark:text-white text-xl font-bold">Dinas Pendidikan</h2>
            </div>
            <p className="text-[#4c739a] dark:text-slate-400 text-sm max-w-sm mb-6">Mewujudkan sistem pendidikan yang berkualitas, inklusif, dan transparan bagi seluruh lapisan masyarakat.</p>
            <div className="flex gap-4">
              <a href="#" className="size-8 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-[#4c739a] hover:bg-primary hover:text-white transition-all"><span className="material-symbols-outlined text-lg">public</span></a>
              <a href="#" className="size-8 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-[#4c739a] hover:bg-primary hover:text-white transition-all"><span className="material-symbols-outlined text-lg">share</span></a>
              <a href="#" className="size-8 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-[#4c739a] hover:bg-primary hover:text-white transition-all"><span className="material-symbols-outlined text-lg">videocam</span></a>
            </div>
          </div>
          <div>
            <h4 className="font-bold mb-6">Layanan Populer</h4>
            <ul className="space-y-4 text-sm text-[#4c739a] dark:text-slate-400">
              <li><a href="#" className="hover:text-primary">Pendaftaran Siswa Baru (PPDB)</a></li>
              <li><a href="#" className="hover:text-primary">Beasiswa Pendidikan</a></li>
              <li><a href="#" className="hover:text-primary">Data Pokok Pendidikan (Dapodik)</a></li>
              <li><a href="#" className="hover:text-primary">Sertifikasi Guru</a></li>
            </ul>
          </div>
          <div>
            <h4 className="font-bold mb-6">Informasi Kontak</h4>
            <ul className="space-y-4 text-sm text-[#4c739a] dark:text-slate-400">
              <li className="flex gap-2">
                <span className="material-symbols-outlined text-primary text-lg">location_on</span>
                <span>Jl. Pendidikan No. 123, Kompleks Perkantoran Pusat</span>
              </li>
              <li className="flex gap-2">
              ...
              <li className="flex gap-2">
                ...
                <span>info@dinaspendidikan.go.id</span>
              </li>
            </ul>
          </div>
        </div>
        <div className="max-w-[1280px] mx-auto px-4 md:px-10 mt-12 pt-8 border-t border-[#e7edf3] dark:border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-[#4c739a]">
          <p>© 2024 Dinas Pendidikan. Seluruh Hak Cipta Dilindungi.</p>
